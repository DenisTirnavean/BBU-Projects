...
void GUI::initGUI()
{
    ...
    layout_right->addWidget(refresh);
...
void CosGUI::connect()
{
    QObject::connect(buton_adauga,&QPushButton::clicked,this,&CosGUI::adauga_in_cos);
    QObject::connect(buton_empty, &QPushButton::clicked, this, &CosGUI::MT_cos);
    QObject::connect(buton_save, &QPushButton::clicked, this, &CosGUI::save_cos);
    QObject::connect(buton_genereaza, &QPushButton::clicked, this, &CosGUI::genereaza);


}
void CosGUI::adauga_in_cos(){
    try {
